...
public class Mountain extends Map{
    public Mountain(){
        super("Mountain","Decreases every champion's damage by 10 and decreases champion's health by 0.1, also reduces healer's healing by 0.2.");
    }
    public void applyEffects(Character character) {
            ...
            if (character instanceof Healer healer) {
                healer.setHealAmount(healer.getHealAmount() * 0.8); // Reduce healing
            }
    }
}
