...
public class SnowyWeather extends Weather {
    public SnowyWeather() {
        super("Snowy",
                "Increases Assassin’s damage by 20, Fighter’s armor by 20; decreases Archer’s movement speed by half, Healer’s damage by 20.");
    }
    ...
    public void applyEffects(Character[] characters) {
        for (Character character : characters) {
            switch (character.getType()) {
                ...
                case "Archer" -> character.setMovementSpeed(character.getMovementSpeed() / 2);
